  ...
  return (
    <div className="space-y-3">
      <input
        ...
        className="t-small w-full rounded-xl border border-gray-200/70 bg-white px-4 py-2.5 placeholder-gray-400 shadow-card transition focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30"
      />
