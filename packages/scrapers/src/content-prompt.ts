...
const POSTS: ContentPost[] = [
  {
    ...
    hashtags: "#houstonpickleball #pickleballhouston #pickleballtournament #pickleballlife #pickleballplayers #dinkresponsibly #pickleballaddiction #htx #pickleballbrackets",
  },
  {
    title: "Field Intel Summary",
    screenshot: "Go to pickleradar.app/houston → tap any tournament with a field strength badge → screenshot the 'Field Intel' green banner showing avg rating, registered count, and the takeaway line.",
    caption: `We analyze rating data for every bracket so you know what you're walking into before you register.\n\nAvg Rating. Sandbagger %. Field strength rating. All in one place.\n\nLink in bio 👆`,
    hashtags: "#houstonpickleball #pickleballhouston #pickleballtournament #pickleballlife #pickleballstrategy #pickleballdata #htx #pickleballaddiction",
  },
  {
    title: "Who's Playing — Player List",
    screenshot: "Go to pickleradar.app/houston → tap a tournament → scroll to 'Who's Playing?' → screenshot an expanded event bracket showing player names and ratings.",
    caption: `See who's already registered and their ratings. Know your competition before you sign up.\n\nLink in bio 👆`,
  ...
  },
  {
    ...
    hashtags: "#houstonpickleball #pickleballhouston #sandbagger #pickleballtournament #pickleballlife #dinkresponsibly #htx #pickleballaddiction #pickleballstrategy",
  },
  {
    title: "Rating Distribution Chart",
    screenshot: "Go to pickleradar.app/houston → tap a tournament → expand an event bracket → screenshot the Rating Distribution bar chart showing the spread of player ratings.",
    caption: `See the full rating spread for every bracket before you register. Is the field tight or are there outliers?\n\nLink in bio 👆`,
    hashtags: "#houstonpickleball #pickleballhouston #pickleballtournament #pickleballdata #pickleballstrategy #pickleballlife #htx #pickleballbrackets",
  },
  {
    title: "Player Profiles",
    screenshot: "Go to pickleradar.app/houston → tap a tournament → expand a bracket → tap any player name → screenshot their profile page showing rating and tournament history.",
    caption: `Every player gets a profile. See their rating and full tournament history across Houston.\n\nLink in bio 👆`,
    hashtags: "#houstonpickleball #pickleballhouston #pickleballtournament #pickleballplayers #pickleballlife #htx #pickleballaddiction",
  },
  {
